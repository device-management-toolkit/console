...
func TestGetBootSourceSetting(t *testing.T) {
	...
	bootSourceSettings := []cimBoot.BootSourceSetting{
		{InstanceID: "PXE", BootString: "PXE Boot Path", BIOSBootString: "PXE BIOS String"},
		{InstanceID: "CD", BootString: "CD Boot Path", BIOSBootString: "CD BIOS String"},
	}
	...
	expected := []dto.BootSources{
		{BootOption: "PXE", BootPath: "PXE Boot Path", Description: "PXE BIOS String"},
		{BootOption: "CD", BootPath: "CD Boot Path", Description: "CD BIOS String"},
	}
