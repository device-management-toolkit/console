...
func (uc *UseCase) GetHardwareInfo(c context.Context, guid string) (dto.HardwareInfo, error) {
	...
	result, err := uc.hardwareInfoToDTO(hwInfo)
	if err != nil {
		return dto.HardwareInfo{}, err
	}
...
func (uc *UseCase) hardwareInfoToDTO(hw interface{}) (dto.HardwareInfo, error) {
...
func (uc *UseCase) GetDiskInfo(c context.Context, guid string) (dto.DiskInfo, error) {
	...
	result, err := uc.discInfoToDTO(diskInfo)
	if err != nil {
		return dto.DiskInfo{}, err
	}
...
func (uc *UseCase) discInfoToDTO(discInfo interface{}) (dto.DiskInfo, error) {
	result := dto.DiskInfo{}
