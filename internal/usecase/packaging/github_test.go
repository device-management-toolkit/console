...
func TestParseAsset(t *testing.T) {
	...
	tests := []struct {
		...
		{"release linux", "rpc_linux_x64.tar.gz", true, "linux", "x64"},
		{"release windows exe", "rpc_windows_x86.exe", true, "windows", "x86"},
...
func TestFilterReleasesCapsAtMaxReleases(t *testing.T) {
	...
	for i := range 12 {
		releases = append(releases, github.Release{
			...
			Assets:  []github.Asset{{Name: "rpc_Linux_x86_64.tar.gz"}},
		})
	}
...
func TestFilterReleasesSkipsPreV3WithinCap(t *testing.T) {
	...
	releases := []github.Release{
		{TagName: "v2.9.0", Assets: []github.Asset{{Name: "rpc_Linux_x86_64.tar.gz"}}},
		{TagName: "v3.1.0", Assets: []github.Asset{{Name: "rpc_Linux_x86_64.tar.gz"}}},
		{TagName: "v3.0.0", Assets: []github.Asset{{Name: "rpc_Linux_x86_64.tar.gz"}}},
	}
