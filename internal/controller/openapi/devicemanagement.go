...
func (f *FuegoAdapter) RegisterDeviceManagementRoutes() {
	...
	fuego.Get(f.server, "/api/v1/admin/amt/userConsentCode/cancel/{guid}", f.cancelUserConsentCode,
		...
		fuego.OptionPath("guid", "Device GUID"),
		fuego.OptionDefaultResponse("Successful cancellation", fuego.Response{
			Type: dto.UserConsentMessage{
				Name:        dto.XMLName{Local: "CancelOptIn_OUTPUT"},
				ReturnValue: 0,
			},
		}),
	)
	...
	fuego.Get(f.server, "/api/v1/admin/amt/userConsentCode/{guid}", f.getUserConsentCode,
		...
		fuego.OptionPath("guid", "Device GUID"),
		fuego.OptionDefaultResponse("User consent code retrieved", fuego.Response{
			Type: dto.GetUserConsentMessage{
				Body: dto.UserConsentMessage{
					Name:        dto.XMLName{Local: "StartOptIn_OUTPUT"},
					ReturnValue: 10,
				},
			},
		}),
	...
	fuego.Post(f.server, "/api/v1/admin/amt/userConsentCode/{guid}", f.sendConsentCode,
		...
		fuego.OptionPath("guid", "Device GUID"),
		fuego.OptionDefaultResponse("User consent code sent successfully", fuego.Response{
			Type: dto.UserConsentMessage{
				Name:        dto.XMLName{Local: "SendOptInCode_OUTPUT"},
				ReturnValue: 0,
			},
		}),
	)
...
func (f *FuegoAdapter) getUserConsentCode(_ fuego.ContextNoBody) (dto.GetUserConsentMessage, error) {
	return dto.GetUserConsentMessage{
		Body: dto.UserConsentMessage{
			Name:        dto.XMLName{Local: "StartOptIn_OUTPUT"},
			ReturnValue: 10,
		},
...
func (f *FuegoAdapter) getGeneralSettings(_ fuego.ContextNoBody) (map[string]any, error) {
