...
type BootSettings struct {
	...
	PBABootFilesPath   []BootParams `json:"pbaBootFilesPath" example:"[{\"instanceID\":\"string\",\"biosBootString\":\"string\",\"bootString\":\"string\"}]"`
	WinREBootFilesPath BootParams   `json:"winreBootFilesPath" example:"{\"instanceID\":\"string\",\"biosBootString\":\"string\",\"bootString\":\"string\"}"`
}
type Features struct {
	...
	PBABootFilesPath      []BootParams `json:"pbaBootFilesPath,omitempty"`
	WinREBootFilesPath    BootParams   `json:"winreBootFilesPath,omitempty"`
}
