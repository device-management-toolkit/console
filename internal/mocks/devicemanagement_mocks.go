...
func (m *MockDeviceManagementRepository) GetActivated(ctx context.Context, top, skip int, tenantID string) ([]entity.Device, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetActivated", ctx, top, skip, tenantID)
	ret0, _ := ret[0].([]entity.Device)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDeviceManagementRepositoryMockRecorder) GetActivated(ctx, top, skip, tenantID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetActivated", reflect.TypeOf((*MockDeviceManagementRepository)(nil).GetActivated), ctx, top, skip, tenantID)
}
...
// GetDeviceStateCounts mocks base method.
func (m *MockDeviceManagementRepository) GetDeviceStateCounts(ctx context.Context, tenantID string) (int, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDeviceStateCounts", ctx, tenantID)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(int)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
// GetDeviceStateCounts indicates an expected call of GetDeviceStateCounts.
func (mr *MockDeviceManagementRepositoryMockRecorder) GetDeviceStateCounts(ctx, tenantID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDeviceStateCounts", reflect.TypeOf((*MockDeviceManagementRepository)(nil).GetDeviceStateCounts), ctx, tenantID)
}

// GetDiscovered mocks base method.
func (m *MockDeviceManagementRepository) GetDiscovered(ctx context.Context, top, skip int, tenantID string) ([]entity.Device, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDiscovered", ctx, top, skip, tenantID)
	ret0, _ := ret[0].([]entity.Device)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDiscovered indicates an expected call of GetDiscovered.
func (mr *MockDeviceManagementRepositoryMockRecorder) GetDiscovered(ctx, top, skip, tenantID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDiscovered", reflect.TypeOf((*MockDeviceManagementRepository)(nil).GetDiscovered), ctx, top, skip, tenantID)
}
...
// GetActivated mocks base method.
func (m *MockDeviceManagementFeature) GetActivated(ctx context.Context, top, skip int, tenantID string) ([]dto.Device, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetActivated", ctx, top, skip, tenantID)
	ret0, _ := ret[0].([]dto.Device)
	ret1, _ := ret[1].(error)
...
// GetActivated indicates an expected call of GetActivated.
func (mr *MockDeviceManagementFeatureMockRecorder) GetActivated(ctx, top, skip, tenantID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetActivated", reflect.TypeOf((*MockDeviceManagementFeature)(nil).GetActivated), ctx, top, skip, tenantID)
}
...
// GetDeviceStateCounts mocks base method.
func (m *MockDeviceManagementFeature) GetDeviceStateCounts(ctx context.Context, tenantID string) (int, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDeviceStateCounts", ctx, tenantID)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(int)
...
// GetDeviceStateCounts indicates an expected call of GetDeviceStateCounts.
func (mr *MockDeviceManagementFeatureMockRecorder) GetDeviceStateCounts(ctx, tenantID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDeviceStateCounts", reflect.TypeOf((*MockDeviceManagementFeature)(nil).GetDeviceStateCounts), ctx, tenantID)
}

// GetDiscovered mocks base method.
func (m *MockDeviceManagementFeature) GetDiscovered(ctx context.Context, top, skip int, tenantID string) ([]dto.Device, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDiscovered", ctx, top, skip, tenantID)
	ret0, _ := ret[0].([]dto.Device)
	ret1, _ := ret[1].(error)
...
// GetDiscovered indicates an expected call of GetDiscovered.
func (mr *MockDeviceManagementFeatureMockRecorder) GetDiscovered(ctx, top, skip, tenantID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDiscovered", reflect.TypeOf((*MockDeviceManagementFeature)(nil).GetDiscovered), ctx, top, skip, tenantID)
}
