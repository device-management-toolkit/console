...
//
//	mockgen -source ./internal/usecase/domains/interfaces.go -package mocks -mock_names Repository=MockDomainsRepository,Feature=MockDomainsFeature -destination ./internal/mocks/domains_mocks.go
//
...
// GetByNameWithCert mocks base method.
func (m *MockDomainsFeature) GetByNameWithCert(ctx context.Context, name, tenantID string) (*entity.Domain, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByNameWithCert", ctx, name, tenantID)
	ret0, _ := ret[0].(*entity.Domain)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetByNameWithCert indicates an expected call of GetByNameWithCert.
func (mr *MockDomainsFeatureMockRecorder) GetByNameWithCert(ctx, name, tenantID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByNameWithCert", reflect.TypeOf((*MockDomainsFeature)(nil).GetByNameWithCert), ctx, name, tenantID)
}
