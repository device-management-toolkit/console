...
//
//	mockgen -source ./internal/usecase/profilewificonfigs/interfaces.go -package mocks -mock_names Repository=MockProfileWiFiConfigsRepository,Feature=MockProfileWiFiConfigsFeature
//
