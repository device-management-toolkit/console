...
//
//	mockgen -source ./internal/usecase/ieee8021xconfigs/interfaces.go -package mocks -mock_names Repository=MockIEEE8021xConfigsRepository,Feature=MockIEEE8021xConfigsFeature
//
