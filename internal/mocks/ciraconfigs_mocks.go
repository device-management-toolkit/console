...
//
//	mockgen -source ./internal/usecase/ciraconfigs/interfaces.go -package mocks -mock_names Repository=MockCIRAConfigsRepository,Feature=MockCIRAConfigsFeature
//
